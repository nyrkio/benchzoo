#!/bin/bash
# Run the tinybench sample-benchmark and capture its JSON output.
#
# tinybench is a library, not a runner — there is no standard output
...
# file so npm noise and any tinybench diagnostic output are preserved
